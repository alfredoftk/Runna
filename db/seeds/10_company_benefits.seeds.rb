region = Region.first
first_benefit = Benefit.create name: "Beneficio estándar 1", region: region
...
second_benefit = Benefit.create name: "Beneficio estándar 2", region: region
...
third_benefit = Benefit.create name: "Beneficio estándar 3", region: region
...
fourth_benefit = Benefit.create name: "Beneficio estándar 4", region: region
